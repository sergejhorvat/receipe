package com.shorvat.recipe.bootstrap;

import com.shorvat.recipe.domain.*;
import com.shorvat.recipe.repositories.CategoryRepository;
...
@Slf4j
@Component
@Profile({"default"}) // running a dev or prod environment wath to use it only once on persistant db
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        // create recipe object with attributes and connected objects
